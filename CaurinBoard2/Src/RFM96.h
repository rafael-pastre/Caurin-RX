...
#define RFM96_REG_DIO_MAPPING_1			0x40	// Mapping for DIO0 to DIO3
...
/* LoRa DIO Configuration (section 4.1.7 - table 17)*/
#define RFM96_LORA_DIO0_RX_DONE			0b00000000
#define RFM96_LORA_DIO0_TX_DONE			0b00000001
#define RFM96_LORA_DIO0_CAD_DONE		0b00000010
#define RFM96_LORA_DIO0_NONE			0b00000011
#define RFM96_LORA_DIO1_NONE			0b00001100
#define RFM96_LORA_DIO2_NONE			0b00110000
#define RFM96_LORA_DIO3_NONE			0b11000000
#define RFM96_LORA_DIO4_NONE			0b00000011
#define RFM96_LORA_DIO5_NONE			0b00001100
...
/* Radio Configuration (MUST BE DONE IN SLEEP OR STANDBY MODES) */
